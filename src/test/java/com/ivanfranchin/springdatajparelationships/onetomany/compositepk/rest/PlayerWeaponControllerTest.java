...
class PlayerWeaponControllerTest implements MyContainers {
  ...
  void testGetWeapon() {
    ...
    String url =
        String.format(API_PLAYERS_PLAYER_ID_WEAPONS_WEAPON_ID_URL, player.getId(), weapon.getId());
    ResponseEntity<WeaponResponse> responseEntity =
        testRestTemplate.getForEntity(url, WeaponResponse.class);
  ...
  void testAddWeapon() {
    ...
    ResponseEntity<WeaponResponse> responseEntity =
        testRestTemplate.postForEntity(url, createWeaponRequest, WeaponResponse.class);
    ...
    Optional<Weapon> weaponOptional =
        weaponRepository.findById(new WeaponPk(responseEntity.getBody().id(), player.getId()));
  ...
  void testRemoveWeapon() {
    ...
    Optional<Weapon> weaponOptional =
        weaponRepository.findById(new WeaponPk(weapon.getId(), player.getId()));
  ...
  private static final String API_PLAYERS_PLAYER_ID_WEAPONS_WEAPON_ID_URL =
      "/api/players/%s/weapons/%s";
}
