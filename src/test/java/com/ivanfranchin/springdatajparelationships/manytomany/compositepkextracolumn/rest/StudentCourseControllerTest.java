...
class StudentCourseControllerTest implements MyContainers {
  ...
  void testGetStudent() {
    ...
    ResponseEntity<StudentResponse> responseEntity =
        testRestTemplate.getForEntity(url, StudentResponse.class);
  ...
  void testUpdateStudent() {
    ...
    String url = String.format(API_STUDENTS_STUDENT_ID_URL, student.getId());
    ResponseEntity<StudentResponse> responseEntity =
        testRestTemplate.exchange(url, HttpMethod.PUT, requestUpdate, StudentResponse.class);
  ...
  void testGetCourse() {
    ...
    ResponseEntity<CourseResponse> responseEntity =
        testRestTemplate.getForEntity(url, CourseResponse.class);
  ...
  void testCreateCourse() {
    ...
    ResponseEntity<CourseResponse> responseEntity =
        testRestTemplate.postForEntity(API_COURSES_URL, createCourseRequest, CourseResponse.class);
  ...
  void testUpdateCourse() {
    ...
    String url = String.format(API_COURSES_COURSE_ID_URL, course.getId());
    ResponseEntity<CourseResponse> responseEntity =
        testRestTemplate.exchange(url, HttpMethod.PUT, requestUpdate, CourseResponse.class);
  ...
  void testEnrollStudentInCourse() {
    ...
    String url =
        String.format(
            API_COURSES_COURSE_ID_STUDENTS_STUDENT_ID_URL, course.getId(), student.getId());
    ResponseEntity<CourseStudentResponse> responseEntity =
        testRestTemplate.postForEntity(url, null, CourseStudentResponse.class);
    ...
    Optional<CourseStudent> courseStudentOptional =
        courseStudentRepository.findById(courseStudentPk);
    assertThat(courseStudentOptional.isPresent()).isTrue();
    courseStudentOptional.ifPresent(
        cs -> {
  ...
  void testUpdateStudentDataInCourse() {
    ...
    UpdateCourseStudentRequest updateCourseStudentRequest =
        new UpdateCourseStudentRequest((short) 8);

    HttpEntity<UpdateCourseStudentRequest> requestUpdate =
        new HttpEntity<>(updateCourseStudentRequest);
    String url =
        String.format(
            API_COURSES_COURSE_ID_STUDENTS_STUDENT_ID_URL, course.getId(), student.getId());
    ResponseEntity<CourseStudentResponse> responseEntity =
        testRestTemplate.exchange(url, HttpMethod.PUT, requestUpdate, CourseStudentResponse.class);
  ...
  private static final String API_COURSES_COURSE_ID_STUDENTS_STUDENT_ID_URL =
      "/api/courses/%s/students/%s";
}
