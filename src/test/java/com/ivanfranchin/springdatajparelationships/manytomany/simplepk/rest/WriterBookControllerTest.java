...
class WriterBookControllerTest implements MyContainers {
  ...
  void testGetWriter() {
    ...
    ResponseEntity<WriterResponse> responseEntity =
        testRestTemplate.getForEntity(url, WriterResponse.class);
  ...
  void testCreateWriter() {
    ...
    ResponseEntity<WriterResponse> responseEntity =
        testRestTemplate.postForEntity(API_WRITERS_URL, createWriterRequest, WriterResponse.class);
  ...
  void testUpdateWriter() {
    ...
    String url = String.format(API_WRITERS_WRITER_ID_URL, writer.getId());
    ResponseEntity<WriterResponse> responseEntity =
        testRestTemplate.exchange(url, HttpMethod.PUT, requestUpdate, WriterResponse.class);
  ...
  void testAddWriterBook() {
    ...
    String url =
        String.format(API_WRITERS_WRITER_ID_BOOKS_BOOK_ID_URL, writer.getId(), book.getId());
    ResponseEntity<WriterResponse> responseEntity =
        testRestTemplate.postForEntity(url, null, WriterResponse.class);
  ...
  void testGetBook() {
    ...
    ResponseEntity<BookResponse> responseEntity =
        testRestTemplate.getForEntity(url, BookResponse.class);
  ...
  void testCreateBook() {
    ...
    ResponseEntity<BookResponse> responseEntity =
        testRestTemplate.postForEntity(API_BOOKS_URL, createBookRequest, BookResponse.class);
  ...
  void testUpdateBook() {
    ...
    String url = String.format(API_BOOKS_BOOK_ID_URL, book.getId());
    ResponseEntity<BookResponse> responseEntity =
        testRestTemplate.exchange(url, HttpMethod.PUT, requestUpdate, BookResponse.class);
  ...
  void testAddBookWriter() {
    ...
    String url =
        String.format(API_BOOKS_BOOK_ID_WRITERS_WRITER_ID_URL, book.getId(), writer.getId());
    ResponseEntity<BookResponse> responseEntity =
        testRestTemplate.postForEntity(url, null, BookResponse.class);
