...
public class WriterBookController {
  ...
  public WriterResponse updateWriter(
      @PathVariable Long writerId, @Valid @RequestBody UpdateWriterRequest updateWriterRequest) {
    Writer writer = writerService.validateAndGetWriter(writerId);
  ...
  public BookResponse updateBook(
      @PathVariable Long bookId, @Valid @RequestBody UpdateBookRequest updateBookRequest) {
    Book book = bookService.validateAndGetBook(bookId);
